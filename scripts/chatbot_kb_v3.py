...
<p><strong>The science.</strong> Color-and-emotion research (Mehrabian &amp; Russell on color-induced affect; Labrecque &amp; Milne 2012 on brand-color associations) consistently shows warm primary hues create stronger emotional response than muted/cool ones. Yellow clusters with joy and energy in the emotion-color literature. For brands serving families, that emotional resonance matters more than formality — warmer hues consistently score higher on perceived approachability and warmth in consumer-brand studies, which is exactly the signal a family ministry needs to project.</p>
...
<p><strong>The neurological reality.</strong> Dark backgrounds with bright color blocks engage <em>figure-ground</em> contrast — the brain locks onto the figure (the colored element) faster against a dark ground than a light one. Figure-ground perception is one of the foundational principles in Gestalt psychology — hardwired, not cultural preference. On a feed where you have two seconds to stop a scroll, that figure-ground speed is everything.</p>
...
<p><strong>The psychology.</strong> Marketing research consistently shows color drives a substantial portion of the initial brand judgment a viewer makes within seconds of first contact. Labrecque &amp; Milne's 2012 work on "Exciting Red and Competent Blue" specifically associated blue with competence, reliability, and stability — and warmer hues with energy and approachability. Combine the two and the brand reads as <em>"dependable AND alive"</em> — which is exactly the signal a Catholic family ministry needs.</p>
...
<p><strong>The brand-consistency research.</strong> Color-and-brand work (Bottomley &amp; Doyle's 2006 study of color-product fit; Madden, Hewett &amp; Roth's 2000 cross-cultural color-preference study) supports the pattern that disciplined global consistency tends to build recognition faster than per-region palette switching — as long as the global palette doesn't violate strong local color taboos. We took this seriously when redesigning the 2026 system.</p>
...
<p><strong>The cognitive research.</strong> Stories activate more of the brain than lists. Neuroscience research (Hasson et al. on neural coupling during storytelling; Raymond Mar's narrative-comprehension work) shows that narrative content lights up motor cortex, sensory cortex, and emotional-processing regions in addition to the language centers — readers/listeners <em>simulate</em> the story neurologically as they process it. Lists activate language centers only. A bullet about "evening family Rosary" doesn't move the reader emotionally. A sentence like "Your family's evening Rosary at the kitchen table — that is the work" puts the reader in their own kitchen.</p>
...
<p><strong>The 2-second rule.</strong> Web-performance research (Akamai and Google mobile-load-time studies) and our own Family Rosary A/B engagement data show that thumb-stop decisions on social feeds happen in a handful of seconds — typically around two — not in paragraphs. Two seconds isn't enough time to read a paragraph. It's barely enough time to register a color block, a face, and a single phrase. Designing for 2-second attention forces high-contrast color, large simple typography, one clear focus per piece — exactly what the 2026 brand system was built for.</p>
...
<p><strong>The research.</strong> Cross-cultural brand-color research (Bottomley &amp; Doyle's 2006 work on color-product fit; Madden, Hewett &amp; Roth's 2000 study of color preferences across eight countries) consistently finds that disciplined global brand consistency tends to outperform region-by-region palette switching for global brands — as long as the global palette doesn't violate strong local color taboos. The intuition that "we should use locally-meaningful colors in each region" tends to backfire — what works is one disciplined global palette applied with cultural sensitivity in <em>execution</em>, not in <em>composition</em>.</p>
