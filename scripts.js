...
(function () {
  ...
  const knowledge = [
    ...
    { q: ['co-branding', 'partner logo', 'two logos'], a: 'Email Victoria or Emmanuel <strong>before</strong> you design anything with a partner organization\'s logo. We have specific rules about how the two logos sit together, the spacing between them, and what needs approval first.' },
    { q: ['report misuse', 'wrong use'], a: 'Email Victoria or Emmanuel with a screenshot or link. We follow up directly with whoever is using the brand wrongly. If it is someone outside HCFM (a vendor, a third-party site), we handle the legal follow-up.' },
    ...
    { q: ['who maintains', 'who owns brand', 'easton creatives', 'who manages brand'], a: 'The HCFM brand is maintained by Victoria Hassan and Emmanuel Epau, working out of the HCFM headquarters in North Easton, MA. Any update to the brand book or this brand portal flows through them. They are sometimes called the "Easton Creatives" team in internal emails — same people.' },
    ...
    { q: ['why calluna', 'calluna body text choice'], a: '<strong>Calluna</strong> (Jos Buivenga) is a serif designed for long-form reading. Its serifs reflect tradition, depth, and reflection — exactly the feel a faith ministry needs for prayer text, donor letters, and reflections. Calluna is also remarkably readable at small sizes, which matters because most HCFM body text appears on phones.' },
    ...
    { q: ['why ministry support', 'easton creatives support', 'team support'], a: 'Victoria and Emmanuel will <strong>review your design before you publish, help you apply the rules in your specific situation, create custom materials when you have a partner organization, commission logo files when the existing pack doesn\'t cover what you need, and run training calls for ministry-center design teams.</strong> The brand book is the floor; we are the safety net for everything above it.' },
